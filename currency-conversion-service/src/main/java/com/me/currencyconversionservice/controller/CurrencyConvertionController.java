package com.me.currencyconversionservice.controller;
...
import com.me.currencyconversionservice.CurrencyExchangeServiceProxy;
import com.me.currencyconversionservice.dto.CurrencyConversion;
...
public class CurrencyConvertionController {
	...
	@GetMapping("/currency-convertor/from/{from}/to/{to}/quatity/{quantity}")
	...
	@GetMapping("/currency-convertor-feign/from/{from}/to/{to}/quatity/{quantity}")
